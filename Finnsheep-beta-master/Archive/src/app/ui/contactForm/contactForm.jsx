...
const ContactForm = () => {
  ...
  return (
    <div>
      {/* <form className="w-full flex h-screen items-center justify-center pt-4 py-20" action={async (formData) => {
      ...
      {/* <div className="grid w-full max-w-sm items-center gap-1.5">
        <p className="text-xl font-medium text-center mb-4">Contact Form</p>
        <div className="">
        ...
        <Input type="tel" id="contactNo" name="contactNo" placeholder="+91 1234 567 890" />
        </div>
        <div className="">
      ...
      <main>
        <section className="w-full xl:py-6 lg:py-6 py-12 bg-slate-50 border-b border-gray-300">
          <div className="w-full max-w-7xl px-6 lg:px-8 mx-auto">
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-16 xl:gap-x-24 gap-y-14 max-w-lg md:max-w-3xl lg:max-w-full mx-auto items-center">
              <div>
                ...
                <div className="my-12 grid md:grid-cols-2 grid-cols-1 md:gap-x-8 gap-y-8">
                  <div className="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-blue-600">
                    <a href="javascript:;" className="w-14 h-14 bg-blue-600 rounded-full flex items-center justify-center mb-5 transition-all duration-500 group-hover:bg-white cursor-pointer">
                      <svg className="fill-white transition-all duration-500 group-hover:fill-blue-600" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 group-hover:text-white">We provide various methods to assist you with your farm product needs. Our support team is here to help.</p>
                  </div>
                  <div className="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-blue-600">
                    <a href="javascript:;" className="w-14 h-14 bg-blue-600 rounded-full flex items-center justify-center mb-5 transition-all duration-500 group-hover:bg-white cursor-pointer">
                      <svg className="stroke-white transition-all duration-500 group-hover:stroke-blue-600" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8.5 10.25H15.25M8.5 15.25H21.5M10.6687 23.75C9.72032 23.75 9.24614 23.75 8.81368 23.916C7.17055 24.5465 4.98937 27.2387 3.24145 26.4602C2.5 26.13 2.5 24.9239 2.5 22.5116C2.5 20.6459 2.5 15.9678 2.5 11.7499C2.5 7.97876 2.5 6.09318 3.67157 4.92161C4.84314 3.75004 6.72865 3.75004 10.4997 3.75003C13.4302 3.75003 16.6564 3.75002 19.5037 3.75002C23.2725 3.75001 25.1568 3.75 26.3284 4.92158C27.5 6.09315 27.5 7.97875 27.5 11.7499C27.5 13.0803 27.5 14.4198 27.5 15.7501C27.5 19.5213 27.5 21.4069 26.3284 22.5785C25.1569 23.75 23.2712 23.75 19.5 23.75C16.5562 23.75 13.6125 23.75 10.6687 23.75Z" stroke="" strokeWidth="2" strokeLinecap="round" />
                      </svg>
                    </a>
                    <h5 className="text-gray-900 text-xl font-semibold leading-8 mb-3 transition-all duration-500 group-hover:text-white">Finnsheep Blog</h5>
                    <p className="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 group-hover:text-white">Discover insights, tips, and stories about sustainable farming. Our blog guides you in your farming journey. </p>
                  </div>
                </div>
                <div className="border-t border-slate-200 pt-12 flex lg:justify-start justify-center">
                  <div className="flex gap-x-1 border-r border-blue-300 items-center">
                    ...
                    <a href="javascript:;" className="text-blue-900 text-lg font-normal leading-7 pl-2.5 pr-3.5">4.9 Rating</a>
                  </div>
                  <a href="javascript:;" className="pl-3.5 text-blue-900 text-lg font-normal leading-7">163 Reviews on <span className="text-emerald-500"> Trustpilot </span>
                  </a>
                </div>
              </div>
              <form className="h-fit bg-white border border-slate-200 rounded-2xl lg:p-12 p-8 w-full max-w-lg md:max-w-3xl lg:max-w-full mx-auto" action={async (formData) => {
                //client-side validation or some other things
                const result = await sendMessage(formData);
                if (result?.err) {
                  //show error
                ...
                <div className="relative mb-6">
                  <label className="flex  items-center mb-2 text-gray-600 text-sm leading-6 font-medium">Name </label>
                  <div className="relative text-gray-500 focus-within:text-gray-900">
                    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none ">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M20 21C20 18.1716 20 16.7574 19.1213 15.8787C18.2426 15 16.8284 15 14 15H10C7.17157 15 5.75736 15 4.87868 15.8787C4 16.7574 4 18.1716 4 21M12.1441 11C12.0541 10.991 11.9459 10.991 11.8468 11C9.7027 10.9278 8 9.16911 8 7.00451C8 4.79481 9.78378 3 12 3C14.2072 3 16 4.79481 16 7.00451C15.991 9.16911 14.2883 10.9278 12.1441 11Z" stroke="#111827" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                    </div>
                    <input type="text" id="name" name="name" className="w-full block h-12 pr-5 pl-12 py-2.5 text-base leading-7 font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none" placeholder="Enter Your Name" onChange={(e) => {
                ...
                <div className="relative mb-6">
                  <label className="flex  items-center mb-2 text-gray-600 text-sm leading-6 font-medium">Email </label>
                  <div className="relative text-gray-500 focus-within:text-gray-900 ">

                    <input type="email" id="email" name="email" className="peer w-full block h-12 pr-5 pl-12 py-2.5 text-base leading-7 font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none invalid:border-pink-500 invalid:text-pink-600" placeholder="Enter Your Email" onChange={(e) => {
                      e.target.value = e.target.value
                        .toLowerCase()
                        .replace(/\s/g, "");
                      handleChange(e);
                    ...
                    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none ">
                      <svg className="peer-invalid:border-pink-500 peer-invalid:text-pink-600" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M2.25201 7L8.15881 10.8953C10.2686 12.1612 11.3235 12.7941 12.4825 12.7665C13.6416 12.739 14.6652 12.0566 16.7124 10.6917L21.748 7M10 20H14C17.7712 20 19.6569 20 20.8284 18.8284C22 17.6569 22 15.7712 22 12C22 8.22876 22 6.34315 20.8284 5.17157C19.6569 4 17.7712 4 14 4H10C6.22876 4 4.34315 4 3.17157 5.17157C2 6.34315 2 8.22876 2 12C2 15.7712 2 17.6569 3.17157 18.8284C4.34315 20 6.22876 20 10 20Z" stroke="#6B7280" strokeWidth="1.5" strokeLinecap="round" />
                      </svg>
                    </div>
                  </div>
                </div>
                <div className="relative mb-6">
                  <label className="flex  items-center mb-2 text-gray-600 text-sm leading-6 font-medium">Phone </label>
                  <div className="relative text-gray-500 focus-within:text-gray-900">
                    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none ">
                    ...
                    <input type="tel" id="contactNo" name="contactNo" className="w-full block h-12 pr-5 pl-12 py-2.5 text-base leading-7 font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none invalid:border-pink-500 invalid:text-pink-600" placeholder="Enter Your Phone No." onChange={(e) => {
                ...
                <div className="relative mb-6">
                  <label className="flex  items-center mb-2 text-gray-600 text-sm leading-6 font-medium">Message </label>
                  <div className="relative ">
                    <textarea type="text" id="message" name="message" className="block w-full h-40 px-4 py-2.5 text-base leading-7 font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-2xl placeholder-gray-400 focus:outline-none resize-none" placeholder="Write your message" onChange={(e) => {
                      handleChange(e);
                    }}></textarea>
                  </div>
                </div>

                <button type="submit" disabled={data.name && data.email && data.contactNo && data.message !== "" ? false : true} className="w-full h-12 rounded-full bg-blue-600 hover:bg-blue-900 transition-all duration-700 shadow-sm text-white text-base font-semibold leading-6 flex items-center justify-center">Send message <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M7.5 15L11.0858 11.4142C11.7525 10.7475 12.0858 10.4142 12.0858 10C12.0858 9.58579 11.7525 9.25245 11.0858 8.58579L7.5 5" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
                </button>
              </form>
            </div>
